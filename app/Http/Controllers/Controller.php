...
class Controller extends BaseController
{
    ...
    public function getcategoriesproduct($order="random")//random, latest
    {
        if($order=="random")
        {
            ...
            ->select('inventories.*','inventories.title as name','inventories.purchase_price as min_price','inventories.sale_price as max_price','images.path as img_path','images.name as img_name','categories.slug as product_cat','category_sub_groups.slug as product_sub_cat','category_sub_groups.name as cat_sub_name')
