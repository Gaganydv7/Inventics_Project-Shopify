  ...
  <div class="dropdn-content account-drop" id="dropdnAccount">
    <div class="dropdn-content-block" >
      ...
      @if(Route::has('login')) 
        @auth
        <hr>
          <li ><a href="##">{{Auth::user()->name}}&nbsp&nbsp<i class="icon-user"></i></a></li>
         <li><a href="##"><span>Checkout&nbsp&nbsp</span><i class="icon-card"></i></a></li>
         <br>
        ...
        @else 
        <li><a href="{{ route('login') }}"><span>Log In&nbsp&nbsp</span><i class="icon-login"></i></a></li>
          @if(Route::has('register'))
          <li><a href="{{ route('create') }}"><span>Register&nbsp&nbsp</span><i class="icon-user2"></i></a></li>
