    ...
    <li class="mmenu-item--simple"><a href="#" class="active no-uppercase"><span>Home</span></a>
      <div class="mmenu-submenu d-flex">
        <ul class="submenu-list mt-0">
          <li><a href="{{route('index')}}">Fashion (Default) Skin</a><span class="submenu-link-image"><img src="images/screen/screen01.png" alt=""></span></li>
        ...
        <ul class="submenu-list">
          ...
          <li><a href="{{route('rightside')}}">Blog</a>
            <ul>
              ...
              <li><a href="{{route('varient1')}}">No sidebar</a></li>
              <li><a href="{{route('varient1')}}">Sticky sidebar</a></li>
              <li><a href="{{route('varient1')}}">Grid</a></li>
              <li><a href="{{route('varient1')}}">Blog post</a></li>
            </ul>
          </li>
