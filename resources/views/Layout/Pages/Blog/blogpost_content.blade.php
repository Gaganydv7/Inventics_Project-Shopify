                ...
                <div class="col-md-14 aside aside--content">
                    <div class="post-full">
                        ...
                        <div class="post-img image-container" style="padding-bottom: 54.44%">
                            <img class="lazyload fade-up-fast" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{$img_url}}{{$current_blog_image->path}}" alt="">
                        </div>
                        <div class="post-text">
                            ...
                            <div class="mt-3"></div>
                            <div class="row">
                                <div class="col-sm"><img class="lazyload fade-up" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{$img_url}}{{$blog_category[1]->path}}" alt=""></div>
                                ...
                                <div class="row vert-margin-middle">
                                    <div class="post-prw-img col-md-7">
                                        <a href="blog-post.html">
                                            <img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{asset('images/blog/blog-01.png')}}" class="lazyload fade-up" alt="">
                                        </a>
                                    </div>
                    ...
                    <div class="post-comments mt-3 mt-md-4" id="postComments">
                            ...
                            <div class="row">
                                <div class="col-auto">
                                    <div class="post-comment-author-img">
                                        <img src="{{asset('images/blog/comment-author.png')}}" alt="" class="rounded-circle">
                                    </div>
                                </div>
                                <div class="col">
                        ...
                        <div class="post-comment">
                            <div class="row">
                                <div class="col-auto">
                                    <div class="post-comment-author-img">
                                        <img src="{{asset('images/blog/comment-author-2.png')}}" alt="" class="rounded-circle">
                                    </div>
                                </div>
                                <div class="col">
                    ...
                    <div class="aside-block">
                        ...
                        <div class="post-prw-simple-sm">
                            <a href="blog-post.html" class="post-prw-img">
                                <img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{$img_url}}{{$blog_category[2]->path}}" class="lazyload fade-up" alt="">
                            </a>
                            <div class="post-prw-links">
