                  ...
                  <div class="cart-table">
                    ...
                    <div class="cart-table-prd">
                      ...
                      @foreach($cat_product as $product)
                          ...
                          <input type="hidden" name="price_of_{{$product->id}}" value="{{$product->min_price +0}}">
      
                        <a href="product/{{$product->product_sub_cat}}/{{$product->product_cat}}/{{$product->slug}}" class="prd-img"><img class="lazyload fade-up" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{$img_url}}{{$product->img_path}}" alt=""></a>
                        @php
                        break;
                      @endphp
                      @endif 
                      ...
                      <div class="cart-table-prd-content-wrap">
                        <div class="cart-table-prd-info">
                          ...
                          <h2 class="cart-table-prd-name"><a href="product/{{$product->product_sub_cat}}/{{$product->product_cat}}/{{$product->slug}}">{{$product->name}}</a></h2>
                        </div>
                        <div class="cart-table-prd-qty">
                          <div class="qty qty-changer">
                          <button class="decrease js-qty-button"></button>
                                  <input type="number" class="qty-input" name="quantity_of_{{$product->id}}" value="{{$cart_item->quantity}}" data-min="1" data-max="1000">
                      ...
                      <div class="cart-table-prd-action">
                        <a href="#" class="cart-table-prd-remove" data-tooltip="Remove Product" title="Remove Product"><i class="icon-recycle"></i></a>
                      </div>
                    </div>
